...
# ============================================ add data ===============================================================
        ...
        def addData():
            if EmployeeName.get() =="" or Address.get()=="" or Reference.get()=="":
                ...
                sqlCon=pymysql.connect(host="localhost", user="root", password="password", database="payment")
                cur = sqlCon.cursor()
...
# ============================================= update =================================================================
        ...
        def update():
            sqlCon = pymysql.connect(host = "localhost", user="root", password="password", database="payment")
            cur = sqlCon.cursor()
            cur.execute("update payment set fullname=%s, address=%s, cityweighting=%s,basicsalary=%s, overtime=%s, grosspay=%s,\
                    tax=%s, pension=%s, nipayment=%s, deductions=%s, postcode=%s, gender=%s, payday=%s,taxperiod=%s,\
                    taxcode=%s, ninumber=%s, netpay=%s where ref = %s",(
...
#=============================================delete=====================================================================
        ...
        RightFrame2d = Frame(RightFrame2, bd=5, width=280, height=50, padx=2, bg="cadetblue", relief=RIDGE)
...
#=======================================================================================================================
        ...
        self.lblPostCode = Label(TopFrame2, font=('arial', 12, 'bold'), text="Post Code", bd=10)
        ...
        self.cboGender = ttk.Combobox(TopFrame2, textvariable = Gender, state = 'readonly', font=('arial', 14, 'bold'), width=46)
    ...
    #=================================================================================================================================================
        ...
        self.txtTaxPeriod = Entry(RightFrame2b, font=('arial', 12, 'bold'), bd=5, width=19, justify='left',
        ...
        self.txtTaxablePay.grid(row=3, column=1)

        self.lblPensionablePay = Label(RightFrame2c, font=('arial', 12, 'bold'), text="Pensionable Pay", bd=10)
        ...
        self.lblNetPay = Label(RightFrame2d, font=('arial', 12, 'bold'), text="NetPay", bd=10)
        ...
        self.txtReference = Entry(LeftFrame1, font=('arial', 12, 'bold'), bd=5, width=18, justify='left',
        ...
        self.txtEmployerName = Entry(LeftFrame1, font=('arial', 12, 'bold'), bd=5, width=18, justify='left',
...
# ==================================================================================================================================================
        ...
        self.btnEquals = Button(RightFrame1a, padx=6, pady=6, bd=2, font=('arial', 16, 'bold'), width=4,
...
# ====================================================================================================================================================
        ...
        TopFramel1 = Frame(Tab2Frame, bd=10, width=1340, height=100, relief = RIDGE)
        TopFramel1.grid(row=0, column=0)
        TopFramel2 = Frame(Tab2Frame, bd=10, width=1340, height=100, relief=RIDGE)
        TopFramel2.grid(row=1, column=0)
# =====================================================================================================================
        self.lblTitle = Label(TopFramel1, font=('arial', 40, 'bold'), text="\tPayroll Management System\t",
                                  bd=10, justify=CENTER)
        self.lblTitle.grid(padx=72)
# ======================================================================================================================

        scroll_x = Scrollbar(TopFramel2, orient = HORIZONTAL)
        scroll_y = Scrollbar(TopFramel2, orient = VERTICAL)

        self.payroll_records = ttk.Treeview(TopFramel2, height=22, columns=("ref","fullname", "address", "cityweighting",
            "basicsalary", "overtime", "grosspay","tax", "pension", "nipayment", "deductions", "postcode", "gender", "payday",
            "taxperiod", "taxcode", "ninumber", "netpay"), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
        ...
        DisplayData()
    # =======================================================================================================================
        TopFramel3 = Frame(Tab3Frame, bd=10, width=1340, height=100, relief=RIDGE)
        TopFramel3.grid(row=0, column=0)
    # =======================================================================================================================
        self.lblNote = Label(TopFramel3, font=('arial', 40, 'bold'), text="\tPayroll Note Book\t",
                                  bd=10, justify=CENTER)
        self.lblNote.grid(row=0, column=0)
    # =======================================================================================================================
        self.txtNote = Text(TopFramel3, width=120, height=22, font=('arial', 14, 'bold'))
